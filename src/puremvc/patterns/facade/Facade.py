...
class Facade(IFacade):
    ...
    def initialize_controller(self):
        ...
        call `super.initialize_controller()` at the beginning of your method, then register `Proxy`s.
    ...
    def initialize_model(self):
        ...
        You have `Proxy`s to register with the Model that does not
        ...
        Note: This method is rarely overridden; in practice, you are more
        likely to use a `Command` to create and register `Proxy`s with the
        `Model`, since `Proxy`s with mutable data will likely need to send
        `INotification`s and thus will likely want to fetch a reference to
        the `Facade` during their construction.
    ...
    def initialize_view(self):
        ...
        Note: This method is rarely overridden; in practice, you are more
        likely to use a `Command` to create and register `Mediator`s with the
